...
const routes: Routes = [
  ...
  { path: 'login', component: LoginComponent },
  {
    ...
    children: [
      ...
      {
        path: 'maestros/trabajador/detalle-trabajador/:empresaId/:empleadoId',
        loadComponent: () => import('./demo/components/trabajador/trabajador-detalle/trabajador-detalle.component')
          .then(m => m.TrabajadorDetalleComponent)
      },
      {
        path: 'maestros/trabajador/nuevo-trabajador',
        loadComponent: () => import('./demo/components/trabajador/trabajador-detalle/trabajador-detalle.component')
          .then(m => m.TrabajadorDetalleComponent)
      },
      {
